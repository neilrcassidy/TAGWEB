...
const AlcoholList = ({ userBadges }) => {
  return (
    <div id="badgesAlcohol" className={`flex flex-col rounded-lg border-secondary border xs:w-[90%] w-[95%]`}>
      <div id="badgesAlcoholTitle" className={`flex bg-secondary rounded-t-md min-w-[90%]`}>
        <div className={`m-auto my-2 ml-3 text-[20px]`}>
          <h3>Alcoholicos de mierda</h3>
        </div>
