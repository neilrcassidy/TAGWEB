...
const AlcoholGrid = ({ userBadges }) => {
  return (
    <div id="badgesAlcohol" className={`flex flex-col rounded-lg border-secondary border max-w-[350px] w-[95%]`}>
      <div id="badgesAlcoholTitle" className={`flex bg-secondary rounded-t-md`}>
