...
const CarnavalesGrid = ({ userBadges }) => {
  return (
    <div id="badgesCarnavales" className={`flex flex-col rounded-lg border-secondary border max-w-[350px] w-[95%]`}>
      <div id="badgesCarnavalesTitle" className={`flex bg-secondary rounded-t-md`}>
      ...
      <div id="badgesCarnavalesGrid" className={`mx-1 my-4`}>
