...
const RutasGrid = ({ userBadges }) => {
  return (
    <div id="badgesRutas" className={`flex flex-col rounded-lg border-[#023020] border max-w-[350px] w-[95%]`}>
      <div id="badgesRutasTitle" className={`flex bg-[#023020] rounded-t-md`}>
