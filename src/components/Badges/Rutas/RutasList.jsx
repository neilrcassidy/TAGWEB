...
const RutasList = ({ userBadges }) => {
  return (
    <div id="badgesRutas" className={`flex flex-col rounded-lg border-secondary border xs:w-[90%] w-[95%]`}>
      <div id="badgesRutasTitle" className={`flex bg-secondary rounded-t-md min-w-[90%]`}>
