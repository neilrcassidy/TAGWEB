...
const CulturaList = ({ userBadges }) => {
  return (
    <div id="badgesCultura" className={`flex flex-col rounded-lg border-secondary border xs:w-[90%] w-[95%]`}>
      <div id="badgesCulturaTitle" className={`flex bg-secondary rounded-t-md min-w-[90%]`}>
