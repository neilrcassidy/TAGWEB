      ...
      <div id="badgesDiscipuloList" className={`min-w-[90%]`}>
        <div className={`flex flex-col`}>
          {badges
            ...
            .map((badge, index) => (
              <div className={`flex w-full ${index === badges.filter((badge) => badge.group === "discipulo").length - 1 ? "" : "border border-transparent border-b-[#c7bc28]"}`}>
