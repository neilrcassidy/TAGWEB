...
const FiestaGrid = ({ userBadges }) => {
  return (
    <div id="badgesFiesta" className={`flex flex-col rounded-lg border-purple-500 border max-w-[350px] w-[95%]`}>
      <div id="badgesFiestaTitle" className={`flex bg-purple-500 rounded-t-md`}>
