...
const FiestaList = ({ userBadges }) => {
  return (
    <div id="badgesFiesta" className={`flex flex-col rounded-lg border-secondary border xs:w-[90%] w-[95%]`}>
      <div id="badgesFiestaTitle" className={`flex bg-secondary rounded-t-md min-w-[90%]`}>
