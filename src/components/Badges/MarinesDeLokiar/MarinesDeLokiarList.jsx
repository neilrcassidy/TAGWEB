...
const MarinesDeLokiarList = ({ userBadges }) => {
  return (
    <div id="badgesMarinesDeLokiar" className={`flex flex-col rounded-lg border-[#FF7F50] border xs:w-[90%] w-[95%]`}>
      <div id="badgesMarinesDeLokiarTitle" className={`flex bg-[#FF7F50] rounded-t-md min-w-[90%] text-[24px]`}>
      ...
      <div id="badgesMarinesDeLokiarList" className={`min-w-[90%]`}>
        <div className={`flex flex-col`}>
          {badges
            .filter((badge) => badge.group === "marines_de_lokiar")
            .sort((badge1, badge2) => badge2.update - badge1.update)
            .map((badge, index) => (
              <div className={`flex w-full ${index === badges.filter((badge) => badge.group === "marines_de_lokiar").length - 1 ? "" : "border border-transparent border-b-[#FF7F50]"}`}>
...
export default MarinesDeLokiarList