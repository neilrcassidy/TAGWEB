...
const MarinesDeLokiarList = ({ userBadges }) => {
  return (
    <div id="badgesMarinesDeLokiar" className={`flex flex-col rounded-lg border-secondary border xs:w-[90%] w-[95%]`}>
      <div id="badgesMarinesDeLokiarTitle" className={`flex bg-secondary rounded-t-md min-w-[90%]`}>
