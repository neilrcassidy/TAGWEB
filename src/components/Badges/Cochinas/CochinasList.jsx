...
const CochinasList = ({ userBadges }) => {
  return (
    <div id="badgesCochinas" className={`flex flex-col rounded-lg border-[#e03f3f] border xs:w-[90%] w-[95%]`}>
      <div id="badgesCochinasTitle" className={`flex bg-[#e03f3f] rounded-t-md min-w-[90%] text-[24px]`}>
      ...
      <div id="badgesCochinasList" className={`min-w-[90%]`}>
