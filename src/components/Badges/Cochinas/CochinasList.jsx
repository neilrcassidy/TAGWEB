...
const CochinasList = ({ userBadges }) => {
  return (
    <div id="badgesCochinas" className={`flex flex-col rounded-lg border-secondary border xs:w-[90%] w-[95%]`}>
      <div id="badgesCochinasTitle" className={`flex bg-secondary rounded-t-md min-w-[90%]`}>
